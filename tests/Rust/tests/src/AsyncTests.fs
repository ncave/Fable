...
// // Do not enable, broken test.
// // returns ResumableStateMachine for some reason
// [<Fact>]
...
let ``Async.Catch works`` () =
    let assign res = function
        ...
        | Choice2Of2 (ex: System.Exception) -> res := "ERROR: " + ex.Message
    let res1 = ref ""
    let res2 = ref ""
    async {
...
//     async {
//         let res = ref 0
//         let t = new System.Timers.Timer(50.)
