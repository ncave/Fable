...
module AstPass =
    ...
    let strings com (i: Fable.ApplyInfo) =
        ...
        | "equals" ->
            ...
            | _ -> None
        | "contains" ->
            makeEqOp i.range [icall com i "indexOf"; makeIntConst 0] BinaryGreaterOrEqual |> Some
        | "startsWith" ->
            makeEqOp i.range [icall com i "indexOf"; makeIntConst 0] BinaryEqualStrict |> Some
